...
public class RecentlyPlayedSongsTest {
	...
	public void test2()
	{
        ...
        songs.playSong("user1","S4");
        songs.playSong("user1","S3");
        songs.playSong("user2","S1");
        songs.playSong("user2","S2");
        songs.playSong("user2","S3");
        songs.playSong("user2","S4");
        songs.playSong("user2","S5");
        Assert.assertEquals(Arrays.asList("S1","S2","S4","S3"),songs.getRecentlyPlayedSongs("user1"));
        Assert.assertEquals(Arrays.asList("S2","S3","S4","S5"),songs.getRecentlyPlayedSongs("user2"));
	}
